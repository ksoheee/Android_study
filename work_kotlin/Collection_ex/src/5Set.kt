...
//     set8.add(50)
    ...
    // list를 통해 set을 생성한다. 중복되는 값이 있을 경우 하나만 남기고 자동 삭제된다.
    ...
    // 합집합
    val set13 = set11.union(set12) // 순서 바뀌어도 같은 결과
    println("set13 : $set13")

    // 차집합
    val set14 = set11.subtract(set12) // 순서 바뀌면 다른 결과
    println("set14 : $set14")

    // 교집합
    val set15 = set11.intersect(set12) // 순서 바뀌어도 같은 결과
    println("set15 : $set15")
}
